...
function AboutSection() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      // Parallax factor: element moves subtly opposite to scroll
      const centerOffset = rect.top + rect.height / 2 - viewportH / 2; // px
      const translate = Math.max(-60, Math.min(60, -0.12 * centerOffset));
  ...
  // IntersectionObserver to reveal items on scroll (match WP appear-from-top)
  useEffect(() => {
    const els = [grillRef.current, leftImgRef.current, rightImgRef.current].filter(Boolean);
    if (!('IntersectionObserver' in window) || els.length === 0) return;
    const io = new IntersectionObserver((entries) => {
      entries.forEach((e) => {
        if (e.isIntersecting) e.target.classList.add('eltdf-in');
      });
    }, { threshold: 0.2 });
  ...
  return (
    <section id="about" className="eltdf-section" style={{ backgroundColor: '#0f1d22', position: 'relative' }}>
      <div className="eltdf-full-width">
        <div className="eltdf-full-width-inner" style={{ position: 'relative' }}>
          {/* Thin vertical grid lines (5 columns) */}
          <div className="eltdf-grid-lines-holder eltdf-grid-columns-5" aria-hidden="true" style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
                  ...
                  <div className="vc_column-inner">
                    <div className="wpb_wrapper">
                      <div className="eltdf-elements-holder eltdf-one-column eltdf-responsive-mode-768">
                        <div className="eltdf-eh-item" data-item-class="eltdf-eh-custom-6635">
                          <div className="eltdf-eh-item-inner">
                            <div className="eltdf-eh-item-content eltdf-eh-custom-6635" style={{ padding: '120px 31% 70px 31%' }}>
                              <div className="eltdf-section-title-holder eltdf-st-decor-animation" style={{ textAlign: 'center' }}>
                                <div className="eltdf-st-inner">
                                  <span className="eltdf-st-tagline">Our Story</span>
                                  <div className="eltdf-st-title-holder">
                                    ...
                                    <h1
                                      className="eltdf-st-title"
                                      style={{
                                        fontFamily: 'caviar_dreamsbold, sans-serif',
                                        fontWeight: 700,
                                  ...
                                  <p className="eltdf-st-text">
                                    Terrascon – Restaurant Français à Paris 14. Découvrez Terrascon, une nouvelle adresse élégante au cœur du 14ᵉ arrondissement de Paris. Notre restaurant réinvente la cuisine française avec raffinement, en associant tradition et créativité dans chaque assiette. Dans un cadre moderne et chaleureux, nous vous invitons à partager un moment convivial autour de plats savoureux, préparés avec des produits frais et de saison. Terrascon vous accueille tout au long de la journée : petit-déjeuner, déjeuner, pause gourmande pour le thé, after work convivial et dîner raffiné. Que ce soit pour un moment intime, une sortie entre amis ou une occasion spéciale, c’est l’endroit idéal pour vivre une expérience culinaire authentique et élégante.
                                  </p>
                                </div>
                              </div>
                            </div>
      ...
      {/* Three-column image/pattern block */}
      <div className="eltdf-row-grid-section-wrapper eltdf-content-aligment-center">
        <div className="eltdf-row-grid-section">
              ...
              <div className="vc_column-inner">
                <div className="wpb_wrapper">
                  <div className="eltdf-elements-holder eltdf-three-columns eltdf-responsive-mode-680">
                    ...
                    {/* Right image */}
                    <div className="eltdf-eh-item" data-item-class="eltdf-eh-custom-8733" data-1400-1600="170px 0 132px 0" data-1025-1399="150px 0 160px 0" data-769-1024="0 0 50px 0" data-681-768="0 0" data-680="0 0">
                      <div className="eltdf-eh-item-inner">
                        <div className="eltdf-eh-item-content eltdf-eh-custom-8733" style={{ padding: '195px 0 160px 10px' }}>
                          <div className="eltdf-single-image-holder eltdf-image-appear-from-top">
                            <div className="eltdf-si-inner eltdf-appear" ref={rightImgRef}>
                              <img loading="lazy" decoding="async" src="/assets/images/image11.jpeg" width="800" height="1013" alt="About right" className="attachment-full size-full" srcSet="/assets/images/image11.jpeg 800w" sizes="(max-width: 800px) 100vw, 800px" />
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      {/* local styles for appear animation */}
      <style>{`
        .eltdf-appear { opacity: 0; transform: translateY(30px); transition: opacity .8s ease, transform .8s ease; }
        .eltdf-appear.eltdf-in { opacity: 1; transform: none; }
      `}</style>
    </section>
  );
}
